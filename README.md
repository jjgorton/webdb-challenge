...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  - SQL is the language we use to communicate with the RDBMLS or Relational DataBase Manegement System which is a collection of tables(relations).

1. Why do tables need a `primary key`?

  - to all the table to have "relations" with other tables and to keep track of the data in the table
...
1. What do we need in order to have a _many to many_ relationship between two tables.
 ...
 - a third table that has a foreign key to both tables.
